...
export const features = [
  {
    ...
    description:
      "Easily design and arrange your components with a user-friendly drag-and-drop interface.",
  },
  {
    icon: <Fingerprint />,
    text: "Multi-Platform Compatibility",
    description:
      "Build applications that run seamlessly across multiple platforms, including mobile, desktops & tablets.",
  },
  {
    icon: <ShieldHalf />,
    text: "Built-in Templates",
    description:
      "Jumpstart your projects with a variety of built-in templates for different types of applications.",
  },
  {
